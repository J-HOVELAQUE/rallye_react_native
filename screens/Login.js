...
import { whiteTa, greyDarkTa, RedButton, RallyeH1, EmailInput, PasswordInput, UserInput, redTa } from '../components/rallye-lib';
                ...
                <View style={{ flex: 1, backgroundColor: greyDarkTa, alignItems: "center", justifyContent: "center" }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{ textAlign: 'center', marginVertical: 10 }}>
                            Vous pourrez ainsi débloquer des fonctionnalités en ajoutant des pilotes à vos favoris.
                            Ainsi, vous pourrez les suivre en direct pendant le rallye !
                        </Text>
