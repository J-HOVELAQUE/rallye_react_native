...
import { RedButton, RallyeH1, greyDarkTa, EmailInput, greyLightTa } from '../components/rallye-lib';
...
//// With this screen the user may edit its profile ////
    ...
    const fixScreen = (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <TouchableHighlight onPress={() => props.navigation.navigate('Snap')}>
                {(props.userConnected.avatar === null
                    || props.userConnected.avatar === ""
                    || props.userConnected.avatar === undefined) ?
                    <Thumbnail
            ...
            <Text style={{ marginBottom: 20 }}>
                <RallyeH1 text={firstName + " " + lastName} />
            </Text>
            <Text style={{ marginBottom: 20 }}>
                <Icon name='globe' size={15} style={{ color: greyDarkTa, marginRight: 10 }} />
                {nationality !== undefined ? nationality.toUpperCase() : 'non renseignée'}
            </Text>

            <Text style={{ marginBottom: 40 }}>
                <Icon name='envelope'
                    size={15}
                    style={{ color: greyDarkTa, marginRight: 10 }} />
                {email}
            </Text>
